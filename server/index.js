...
app.listen(PORT, () => {
  ...
  // Start cron service for automation
  if (process.env.ENABLE_AUTO_POSTER === 'true') {
    cronService.start();
    console.log('🤖 Auto-poster cron service started');
  } else {
    console.log('⚠️  Auto-poster disabled (set ENABLE_AUTO_POSTER=true to enable)');
  }
});
